...
# paired t-test for reference paper
...
write.csv(data.frame(rmse_res_l0_mean,rmse_res_Wang_mean), file="../Results/d.csv")

#Shapiro-Wilk: Whether the difference of normality test conforms to the normal distribution
